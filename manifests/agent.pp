      ...
      case $linux_provider {
        'package_manager': {
          ...
          case $facts['os']['name'] {
            ...
            'RedHat', 'CentOS', 'Amazon', 'OracleLinux', 'AlmaLinux', 'Rocky': {
            ...
            'OpenSuSE', 'SuSE', 'SLED', 'SLES': {
              ...
              -> exec { 'add_newrelic_repo':
                ...
                command => "/usr/bin/zypper addrepo --repo https://download.newrelic.com/infrastructure_agent/linux/zypp/sles/${facts['os']['release']['full']}/x86_64/newrelic-infra.repo",
